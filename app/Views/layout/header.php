...
<head>
    ...
    <meta name="description" content="Mentup &eacute; uma plataforma simples para organizar campeonatos, times, partidas e resultados esportivos.">
    ...
    <header class="site-header" id="inicio">
        <div class="container header__inner">
            ...
            <div class="header-actions">
                ...
                <a class="btn btn--primary" href="cadastro.php">Comece agora</a>
            </div>
        </div>
    </header>
    <main>
